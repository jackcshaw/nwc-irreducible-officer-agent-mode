...
Do not answer from the essay alone. Use the context file to help me do one useful thing with the argument: understand it, inspect a claim, test an objection, practice a workflow, design an exercise, create a flawed AI assessment, run oral defense, or build a trace.
...
- **What should faculty practice?** The workflow patterns and starter prompts let faculty work against the essay with an AI assistant, building fluency before they ask students to do the same.
